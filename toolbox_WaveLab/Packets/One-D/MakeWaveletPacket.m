...
%    d -- level of fineness/ depth of the wavelet packet tree
%         1 <= d <= log2(n)
%    b -- index of the basis function w.r.t. frequency at level/depth d
%         0 <= b <= 2^d-1
%    k -- shift/translation in space of the basis function
%         0 <= k <= n/2^j-1
%
